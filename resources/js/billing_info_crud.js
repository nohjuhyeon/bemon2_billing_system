...
document.addEventListener('DOMContentLoaded', () => {
    ...
    collectionSetupForm('chargeThirdPartyForm', 'editButtonChargeThirdParty', 'saveButtonChargeThirdParty', 'addButtonChargeThirdParty', 'deleteButtonChargeThirdParty', 'cancelButtonChargeThirdParty', 'selectAllChargeThirdParty', '#valueDataChargeThirdParty', '#inputDataChargeThirdParty', 'CHARGE_THIRD_PARTY');
    collectionSetupForm('chargeManagedServiceForm', 'editButtonChargeManagedService', 'saveButtonChargeManagedService', 'addButtonChargeManagedService', 'deleteButtonChargeManagedService', 'cancelButtonChargeManagedService', 'selectAllChargeManagedService', '#valueDataChargeManagedService', '#inputDataChargeManagedService', 'CHARGE_MANAGED_SERVICE');
    collectionSetupForm('chargeOtherServiceForm', 'editButtonChargeOtherService', 'saveButtonChargeOtherService', 'addButtonChargeOtherService', 'deleteButtonChargeOtherService', 'cancelButtonChargeOtherService', 'selectAllChargeOtherService', '#valueDataChargeOtherService', '#inputDataChargeOtherService', 'CHARGE_OTHER_SERVICE');
});
